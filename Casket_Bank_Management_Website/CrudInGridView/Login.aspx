...
<body>
  ...
  <asp:p class="error">Error. Please enter correct Username &amp; password.</asp:p>
    ...
    <asp:TextBox placeholder="Username" ID="txtUserName" runat="server" type="text" class="username" Text="Username"></asp:TextBox>
     <br /><br /><asp:TextBox placeholder="Password" runat="server" ID="txtPassword" TextMode="Password" type="password" class="password"></asp:TextBox>
                   <br /><br />
<asp:Button class="submit" ID="btnLogin" runat="server" Text="LOGIN" OnClick="btnLogin_Click" ></asp:Button>
</div>
</section>
