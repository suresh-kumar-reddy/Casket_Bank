<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="emp_login.aspx.cs" Inherits="CrudInGridView.emp_login" %>
...
<body>
  ...
  <asp:p class="error">Error. Please enter correct Username &amp; password.</asp:p>
    ...
    <asp:TextBox placeholder="Emp ID" ID="txtUserName" runat="server" type="text" class="username" Text="Username"></asp:TextBox>
     <br /><br /><asp:TextBox placeholder="Password" runat="server" ID="txtPassword" TextMode="Password" type="password" class="password"></asp:TextBox>
                   <br /><br />
