<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Account.aspx.cs" Inherits="CrudInGridView.Account" %>
...
<body style="border:2px solid white;">
    ...
    <form id="form1" runat="server">
     ...
     <center><h2 style="color:white;">CASKET BANK</h2>
            ...
            <asp:GridView ID="gvPhoneBook" runat="server" AutoGenerateColumns="false" ShowFooter="true" DataKeyNames="aid"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Balance">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("Balance") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtBalance" Text='<%# Eval("Balance") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtBalanceFooter" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Account Type">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("Acc_type") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtAcc_type" Text='<%# Eval("Acc_type") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtAcc_typeFooter" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:TemplateField HeaderText="IFSC_code">
                        <ItemTemplate>
                            <asp:Label Text='<%# Eval("IFSC_code") %>' runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="txtIFSC_code" Text='<%# Eval("IFSC_code") %>' runat="server" />
                        </EditItemTemplate>
                        <FooterTemplate>
                            <asp:TextBox ID="txtIFSC_codeFooter" runat="server" />
                        </FooterTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                        <ItemTemplate>
